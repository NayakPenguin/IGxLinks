...

            {
                ...
                <div className="main-content">
                    ...
                    <AboutMeSection>
                        ...
                        <div className="para">I’m a Computer Science graduate from Jadavpur University (2025) and now a Software Developer at Samsung R&D Bangalore, working across scalable backend systems, performance engineering, and full-stack development. I built an automated bottleneck-detection pipeline using Google Perfetto during my internship and continue to work on high-impact systems. I’m also the founder and open-source maintainer of algolisted.com and previously served as the development lead for GDSC JU. With an Expert rating on Codeforces (1689), I enjoy solving complex engineering problems and building reliable, data-driven, scalable products.</div>
                    </AboutMeSection>
